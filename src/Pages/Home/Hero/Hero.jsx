      ...
      <Container style={{ padding: "20px 50px" }}>
        <Grid container spacing={2}>
          ...
          >
            <Box>
              ...
              >
                ...
                dignissimos possimus aliquid. Rerum, libero veritatis id
                officiis dolores, ratione repellendus, inventore numquam rem
                fugit aperiam consequatur suscipit atque non libero.
              </Typography>
          ...
          <Grid item xs={12} md={6}>
            <img style={{ width: "100%" }} src={heroCar} alt="Hero car" />
          </Grid>
        </Grid>
      </Container>
    </Box>
